...
# 0.7.6
- fixed issue [#110](https://github.com/janisdd/vscode-edit-csv/issues/110) - Add feature to swap rows and columns

# 0.7.5
- fixed issue [#111](https://github.com/janisdd/vscode-edit-csv/issues/111) - add feature resize columns and rows
...
- fixed issue [#115](https://github.com/janisdd/vscode-edit-csv/issues/115) - Add newline at the end of file
...
# 0.7.4
- fixed issue [#112](https://github.com/janisdd/vscode-edit-csv/issues/112) - added keyboard shortcut to delete the current row (`ctrl+shift+alt+minus`)
...
- added option `csv-edit.showDeleteColumnHeaderButton` true: shows a delete column button in the column header (on hover), false: not (fixes issue [#113](https://github.com/janisdd/vscode-edit-csv/issues/113))
- added option `csv-edit.showDeleteRowHeaderButton` true: shows a delete row button in the row header (on hover), false: not  (fixes issue [#113](https://github.com/janisdd/vscode-edit-csv/issues/113))
- fixed issue [#114](https://github.com/janisdd/vscode-edit-csv/issues/114) - "dynamic csv" is now also supported as *language id*
