...
- [#187](https://github.com/PDConSec/vsc-print/issues/187) bugfixes
	- don't force alternate browser on
	- fix alternate browser path check logic
- [#194](https://github.com/PDConSec/vsc-print/issues/194) add a renderer for plaintext documents so they aren't treated as source code
- [#184](https://github.com/PDConSec/vsc-print/issues/184) filepath as header at start of document (controlled by a setting)
- [#184](https://github.com/PDConSec/vsc-print/issues/184) format control for file paths in headings of documents
	- Relative
	- Absolute, with tilde pathing for paths in the user's home directory
- [#188](https://github.com/PDConSec/vsc-print/issues/188) format control for file paths in document titles (used in page headers by some browsers)
	- No path
	- Relative
...
- fix [#181](https://github.com/PDConSec/vsc-print/issues/181) use editor font when printing source code (broken by refactoring)
- fix [#182](https://github.com/PDConSec/vsc-print/issues/182) file explorer context-menu print now supports multiselection 
- fix [#183](https://github.com/PDConSec/vsc-print/issues/183) unexpected commas
...
- Syntax colouring fix for multi-line strings and comments, thanks to [gji](https://github.com/gji) closes [#85](https://github.com/PDConSec/vsc-print/issues/85) and [#63](https://github.com/PDConSec/vsc-print/issues/63)
